...
(function () {
    ...
    var searchBarOnOff = {
        ...
        searchBarAfter: document.querySelector('.tx-notice'),
    }
    var tabMenu = {
        ...
        switch (true) {
            ...
            case el.classList.contains('testCase5') :
                if (searchRctly.srchRctlyParent.querySelectorAll('.srch-rctly').length) {
                    ...
                    searchRctly.srchRctlyParent.insertBefore(searchRctly.srchRctly, searchRctly.srchAfter);
                }
                break;
