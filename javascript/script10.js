(function (win, $, doc) {
    ...
    win.HYFRESH[pluginName].prototype = {
        ...
        offsetFunc : function (value, index) {
            value.layerWrap.find('.common-layer__wrapper').scrollTop(value.layerWrap.find(".common-layer__content > p[data-offset=\""+index+"\"]").position().top)
        },
        onLayerOpen : function (e) {
            ...
            if ($(e.target).data("offset")) {
                indexOffset = $(e.target).data("offset");
            }
